...
import com.example.revesion.databinding.FragmentSecoundBinding;
...
public class SecoundFragment extends Fragment {
    ...
    public static SecoundFragment newInstance(String param1) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FragmentSecoundBinding binding=FragmentSecoundBinding.inflate(inflater,container,false);
        binding.tv.setText(mParam1);
